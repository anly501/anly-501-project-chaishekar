...
#search hashtage
#USACRIME
Search=twitteR::searchTwitter("#USA#crime",n=10000, since="2000-01-01", lang="en")
(Search_DF = twListToDF(Search))

(Search_DF$text[1])

write.csv(Search_DF,"R_USACRIME_API.csv")


File_Name = "R_USACRIME_API.txt"
#Start the file
...
##CRIMEUSA
Search=twitteR::searchTwitter("#crime#USA",n=10000, since="2000-01-01", lang="en")
write.csv(Search_DF,"R_CRIMEUSA_API.csv")
File_Name = "R_CRIMEUSA_API.txt"
#Start the file
MyFile <- file(File_Name)
#Write Tweets to file
cat(unlist(Search_DF), " ", file=MyFile, sep="\n\n\n")
